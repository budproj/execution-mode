...
export const KeyResultTooltipSupportTeam = () =>
  <Box pb={2}>
    <Text>O time de apoio é uma ou mais pessoas que apoiam o responsável em um resultado-chave. No Bud, isso significa:</Text>

    <TooltipHeading>CHECK-INS:</TooltipHeading>
    <Text>O time de apoio tambem pode fazer check-in nos resultados-chave dos quais participam.</Text>
    ...
    <Text>As notificações relacionadas a este resultado-chave, como novos comentários, também serão enviadas ao time de apoio.</Text>
  </Box>