...
export interface LowPriorityIconIconroperties extends IconProps, AcessibleIconProperties {}

const LowPriorityIcon = ({ title, desc, ...rest }: LowPriorityIconIconroperties): ReactElement => (
